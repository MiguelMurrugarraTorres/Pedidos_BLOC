import 'bloc/metodos_de_pago_one_bloc.dart';
import 'models/metodos_de_pago_one_model.dart';
...
class MetodosDePagoOneScreen extends StatelessWidget {
  const MetodosDePagoOneScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<MetodosDePagoOneBloc>(
      create: (context) => MetodosDePagoOneBloc(MetodosDePagoOneState(
        metodosDePagoOneModelObj: MetodosDePagoOneModel(),
      ))
        ..add(MetodosDePagoOneInitialEvent()),
      child: MetodosDePagoOneScreen(),
    );
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<MetodosDePagoOneBloc, MetodosDePagoOneState>(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              CustomImageView(
                                imagePath: ImageConstant.imgUserGray60017x25,
                                height: 17.v,
                                width: 25.h,
