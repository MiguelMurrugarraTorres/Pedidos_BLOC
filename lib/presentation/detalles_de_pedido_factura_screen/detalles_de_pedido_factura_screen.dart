import 'bloc/detalles_de_pedido_factura_bloc.dart';
import 'models/detalles_de_pedido_factura_model.dart';
...
class DetallesDePedidoFacturaScreen extends StatelessWidget {
  DetallesDePedidoFacturaScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<DetallesDePedidoFacturaBloc>(
      create: (context) =>
          DetallesDePedidoFacturaBloc(DetallesDePedidoFacturaState(
        detallesDePedidoFacturaModelObj: DetallesDePedidoFacturaModel(),
      ))
            ..add(DetallesDePedidoFacturaInitialEvent()),
      child: DetallesDePedidoFacturaScreen(),
    );
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: BlocSelector<DetallesDePedidoFacturaBloc,
                          DetallesDePedidoFacturaState, TextEditingController?>(
